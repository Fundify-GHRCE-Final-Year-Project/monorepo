...
export default function ProjectDetailPage() {
  ...
  const { project, isLoading, error } = useGetSelectedProject(owner, index);
  ...
  const milestonePercentages = calculateMilestonePercentages(
    project.milestones
  );
                ...
                <div className="grid grid-cols-2 gap-4 text-sm">
                  <div>
                    ...
                    <div className="font-semibold">
                      {formatEthAmount(project.goal)}
                    </div>
                  </div>
                  <div>
                    <div className="text-muted-foreground">Funded</div>
                    <div className="font-semibold">
                      {formatEthAmount(project.funded)}
                    </div>
                  </div>
                  <div>
                    <div className="text-muted-foreground">Remaining</div>
                    <div className="font-semibold">
                      {formatEthAmount(remainingFunding)}
                    </div>
                  </div>
                  <div>
                    <div className="text-muted-foreground">Released</div>
                    <div className="font-semibold">
                      {formatEthAmount(project.released)}
                    </div>
                  </div>
                </div>
              </div>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                ...
                {project.milestones !== 1 ? "s" : ""} for fund release
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-4">
                    ...
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        ...
                        <div className="text-sm text-muted-foreground">
                          {formatEthAmount((project.goal * percentage) / 100)} (
                          {percentage}%)
                        </div>
                      </div>
                    </div>
